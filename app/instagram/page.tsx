    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="p-6 rounded-2xl glass-card border border-white/10 space-y-6">
        {account ? (
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                {account.profilePictureUrl ? (
                  ...
                  <div className="w-14 h-14 rounded-full bg-purple-500/20 flex items-center justify-center font-bold text-purple-300 ring-2 ring-purple-500/40">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-0.5">
                  Account Type: <span className="text-purple-300 font-semibold">{account.accountType || 'PROFESSIONAL'}</span> • ID: <code className="text-slate-300">{account.instagramUserId}</code>
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4 border-b border-white/10">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-500">
