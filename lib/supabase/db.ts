  ...
  accounts: [
    {
      ...
      accountType: 'CREATOR',
      accessTokenEncrypted: encryptToken('mock_valid_token'),
      status: 'CONNECTED',
  ...
  media: [
    {
      ...
      instagramMediaId: 'reel_learn_ai',
      mediaType: 'REEL',
      caption: 'Learn AI in 30 Days! Comment AI and I will send you my complete beginner roadmap 🚀 #ai #coding',
      thumbnailUrl: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=600&auto=format&fit=crop&q=80',
      permalink: 'https://instagram.com/p/C09123456',
    ...
    },
    {
      id: 'med-2',
      instagramAccountId: 'acc-1',
      instagramMediaId: 'reel_ml_course',
      mediaType: 'REEL',
      caption: 'My Machine Learning Course is now live! Comment ML or COURSE for 50% discount coupon 🏷️',
      thumbnailUrl: 'https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=600&auto=format&fit=crop&q=80',
      permalink: 'https://instagram.com/p/C09789012',
    ...
    },
    {
      id: 'med-3',
      instagramAccountId: 'acc-1',
      instagramMediaId: 'post_workflow_tips',
      mediaType: 'IMAGE',
      caption: '5 Automations that save me 10 hours every week as a solo creator. Save this post! 📌',
      thumbnailUrl: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=600&auto=format&fit=crop&q=80',
      permalink: 'https://instagram.com/p/C09333444',
  ...
  automations: [
    {
      ...
      instagramAccountId: 'acc-1',
      mediaId: 'med-1',
      name: 'AI Roadmap Reel',
      status: 'ACTIVE',
      matchType: 'CONTAINS',
      matchMode: 'ANY',
      triggers: [
        { id: 'trig-1', automationId: 'auto-1', keyword: 'AI' },
        { id: 'trig-2', automationId: 'auto-1', keyword: 'ROADMAP' },
      ],
      actions: [
        {
          id: 'act-1',
          ...
          message: 'Thanks @{{username}}! Check your DM for the roadmap 👋',
        },
        {
          id: 'act-2',
          automationId: 'auto-1',
          actionType: 'PRIVATE_MESSAGE',
          message: 'Hey {{username}} 👋 Here is the AI roadmap you requested: https://example.com/roadmap',
        },
      ],
    ...
    },
    {
      ...
      instagramAccountId: 'acc-1',
      mediaId: 'med-2',
      name: 'Course Link Reel',
      status: 'PAUSED',
      matchType: 'CONTAINS',
      matchMode: 'ANY',
      triggers: [
        { id: 'trig-3', automationId: 'auto-2', keyword: 'ML' },
        { id: 'trig-4', automationId: 'auto-2', keyword: 'COURSE' },
      ],
      actions: [
        {
          id: 'act-3',
          automationId: 'auto-2',
          actionType: 'PRIVATE_MESSAGE',
          message: 'Hey! Here is your exclusive 50% discount link: https://example.com/course',
        },
      ],
  ...
  events: [
    {
      id: 'evt-1',
      automationId: 'auto-1',
      automationName: 'AI Roadmap Reel',
      instagramAccountId: 'acc-1',
      instagramCommentId: 'c_1001',
      commenterUsername: 'alex_dev',
      commentText: 'Can you send me the AI roadmap please?',
      actionType: 'PRIVATE_MESSAGE',
      responseContent: 'Hey alex_dev 👋 Here is the AI roadmap you requested: https://example.com/roadmap',
      status: 'SENT',
    ...
    },
    {
      ...
      commentText: 'Can you send me the AI roadmap please?',
      actionType: 'PUBLIC_REPLY',
      responseContent: 'Thanks @alex_dev! Check your DM for the roadmap 👋',
      status: 'SENT',
      createdAt: new Date(Date.now() - 1000 * 60 * 15).toISOString(),
    },
    {
      ...
      automationName: 'AI Roadmap Reel',
      instagramAccountId: 'acc-1',
      instagramCommentId: 'c_1002',
      commenterUsername: 'sarah_tech',
      commentText: 'AI',
      actionType: 'PRIVATE_MESSAGE',
      responseContent: 'Hey sarah_tech 👋 Here is the AI roadmap you requested: https://example.com/roadmap',
      status: 'SENT',
...
export async function getDashboardStats() {
  ...
  return {
    commentsDetected: commentsDetected || 1842,
    commentsMatched: matched || 426,
    messagesSent: messagesSent || 397,
    failed: failed || 0,
  };
}
